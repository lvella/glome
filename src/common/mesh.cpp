...
static std::weak_ptr<Mesh> mesh_list[size_t(Mesh::Type::MESH_COUNT)];
...
Mesh::draw(Camera& c)
{
	...
	glVertexAttribPointer(Shader::ATTR_POSITION, 4, GL_FLOAT, GL_FALSE, stride, nullptr);
